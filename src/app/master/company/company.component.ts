...
export class CompanyComponent implements OnInit, OnDestroy {
  ...
  public chartLabels: any[] = ['Open', 'WIP', 'Close'];
  ...
  userRole: string;
  // tslint:disable-next-line:max-line-length
  constructor(private engineService: EngineService, private alertService: AlertService, public dialog: MatDialog) { }
  ...
  public updateCompany(companies: any) {
    this.rows = companies;
    this.temp = [...this.rows];
